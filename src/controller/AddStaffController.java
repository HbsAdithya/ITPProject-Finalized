...
/**
 *
 * @author AddStaffController
 */
@WebServlet(urlPatterns = { "/AddStaffController" })
public class AddStaffController extends HttpServlet {
	...
	private static final long serialVersionUID = -3521171316622702772L;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String q1 = "insert into (id,full_name, address, designation, dob, age, gender, nic, phone) staff values (?,?,?,?,?,?,?,?,?)";
